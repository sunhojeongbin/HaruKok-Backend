...
export class TodoController {
  constructor(
    ...
    private readonly updateTodoCompletionUseCase: UpdateTodoCompletionUseCase,
    private readonly repeatTodoTodayUseCase: RepeatTodoTodayUseCase,
    private readonly repeatTodoTomorrowUseCase: RepeatTodoTomorrowUseCase,
    private readonly repeatTodoNextUseCase: RepeatTodoNextUseCase,
    private readonly deleteTodoUseCase: DeleteTodoUseCase,
    private readonly searchTodosUseCase: SearchTodosUseCase,
  ...
  async create(@CurrentUserId() userId: string, @Body() dto: CreateTodoDto) {
    const todo = await this.createTodoUseCase.execute(userId, dto);
  ...
  async update(
    ...
    const todo = await this.updateTodoUseCase.execute(userId, todoId, dto);
    return ApiResponseDto.success(
      todo,
  ...
  async updateCompletion(
    ...
    const todo = await this.updateTodoCompletionUseCase.execute(userId, todoId);
    return ApiResponseDto.success(
      todo,
  ...
  async repeatToday(
    ...
    const todo = await this.repeatTodoTodayUseCase.execute(userId, todoId);
    return ApiResponseDto.success(
      todo,
  ...
  async repeatTomorrow(
    ...
    const todo = await this.repeatTodoTomorrowUseCase.execute(userId, todoId);
    return ApiResponseDto.success(
      todo,
  ...
  async repeatNext(
    ...
    const todos = await this.repeatTodoNextUseCase.execute(
      userId,
      todoId,
      dto.dates,
    );
  ...
  async delete(
    ...
    const deleted = await this.deleteTodoUseCase.execute(userId, todoId);
    return ApiResponseDto.success(
      deleted,
  ...
  async search(
    ...
    const todos = await this.searchTodosUseCase.execute(userId, query.keyword);
    return ApiResponseDto.success(
      todos,
  ...
  async getById(
    ...
    const todo = await this.getTodoByIdUseCase.execute(userId, todoId);
    return ApiResponseDto.success(
      todo,

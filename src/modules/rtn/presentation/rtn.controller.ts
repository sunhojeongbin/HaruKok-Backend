...
export class RtnController {
  constructor(
    ...
    private readonly reorderRtnUseCase: ReorderRtnUseCase,
    private readonly updateRtnUseCase: UpdateRtnUseCase,
    private readonly deleteRtnUseCase: DeleteRtnUseCase,
    private readonly getRtnByIdUseCase: GetRtnByIdUseCase,
    private readonly getRtnListUseCase: GetRtnListUseCase,
  ) {}
  ...
  async create(@CurrentUserId() userId: string, @Body() dto: CreateRtnDto) {
    const routine = await this.createRtnUseCase.execute(userId, dto);
  ...
  async reorder(@CurrentUserId() userId: string, @Body() dto: ReorderRtnDto) {
    const routines = await this.reorderRtnUseCase.execute(userId, dto);
    return ApiResponseDto.success(
      routines,
  ...
  async update(
    ...
    const routine = await this.updateRtnUseCase.execute(userId, rtnId, dto);
    return ApiResponseDto.success(
      routine,
  ...
  async delete(
    ...
    const deleted = await this.deleteRtnUseCase.execute(userId, rtnId);
    return ApiResponseDto.success(
      deleted,
  ...
  async getById(
    ...
    const routine = await this.getRtnByIdUseCase.execute(userId, rtnId);
    return ApiResponseDto.success(
      routine,
  ...
  async getList(@CurrentUserId() userId: string) {
    const routines = await this.getRtnListUseCase.execute(userId);
    return ApiResponseDto.success(
      routines,
